...
class XML_REVIEW_DATASET(object):
    ...
    def ReadReview(self):
        ...
        app_data_path = '../Datasets/Review_Ds/' + \
            self.dataset.name + "/" + self.app_name.name + ".xml"
        ...
        for sent in sentences:
            ...
            sents_with_aspect_terms[review_id] = {
                'review_sent': sent_text, 'true_features': list_aspect_terms, 'predicted_features': [], 'review-id': review_id}
