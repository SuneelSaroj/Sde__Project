...
class preprocessing:
    ...
    def SegmemtintoSentences(self, sents_already_segmented=False):
        ...
        if sents_already_segmented == True:
            ...
            for line in list_lines:
                ...
                sentences = [self.ReplaceCommonTypos(
                    sent) for sent in sentences if sent.strip() != '']
            ...
            self.sents = [self.ReplaceCommonTypos(
                sent) for sent in self.sents if sent.strip() != '']

        return self.sents

    # clean sentences
    def ReplaceCommonTypos(self, sent):
        typos = [["im", "i m", "I m", "I'm", "i'm"], ["Ill", "I'll", "i'll"], ["cnt", "cant", "can't", "cann't"], ["doesnt", "doesn't"], ["dont", "don't"], ["isnt", "isn't"], ["didnt", "didn't"], ["couldnt", "couldn't"], ["Cud"], ["wasnt", "wasn't"], ["wont", "won't"], ["wouldnt", "wouldn't"], ["ive", "i've"], ["Ive", "I've"], ["theres", "there's"], ["awsome", "awsum", "awsm"], ["Its", "it's", 'itz', "it'z"], ["dis", "diz"], ["plzz", "Plz ", "plz", "pls ", "Pls", "Pls "], ["U", "u"], ["ur"], [
            "b"], ["r"], ["nd ", "n", "&"], ["bt"], ["nt"], ["coz", "cuz"], ["jus", "jst"], ["luv", "Luv"], ["gud"], ["Gud"], ["wel"], ["gr8", "Gr8", "Grt", "grt"], ["Gr\\."], ["pics"], ["pic"], ["hav"], ["nic"], ["nyc", "9ce"], ["Nic"], ["agn"], ["thx", "tks", "thanx"], ["Thx"], ["thkq"], ["Xcellent"], ["vry"], ["Vry"], ["fav", "favo"], ["soo", "sooo", "soooo"], ["ap"], ["b4"], ["ez"], ["w8"], ["msg"], ["alot"], ["lota"], ["kinda"], ["omg"], ["gota"], ['v', 'w', 'V', 'W'], ['c'], ['b'], ['nt']]
        replacements = ["I am", "i will", "can not", "does not", "do not", "is not", "did not", "could not", "Could", "was not", "will not", "would not", "I have", "I have", "there is", "awesome", "It is", "this", "please", "you", "your", "be", "are", "and", "but", "not", "because", "just", "love", "good", "Good",
                        "well", "great", "Great\\.", "pictures", "picture", "have", "nice", "nice", "Nice", "again", "thanks", "Thanks", "thank you", "excellent", "very", "Very", "favorite", "so", "app", "before", "easy", "wait", "message", "a lot", "lot of", "kind of", "oh, my god", "going to", "we", "see", "be", "not"]
    ...
    def GetCleanSentences(self):
        ...
        for index, sent in enumerate(clean_sentences):
            ...
            sent_tokens = [w.lower() for w in tokens if stemmer.stem(
                w.lower()) not in cutom_stop_words_stemmed]
